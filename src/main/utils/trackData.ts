...
export const discordEmbedFromTrack = (track: TrackData, presenceTitle: string, playing: boolean = true, progress: number = 0): Presence => {
	...
	return {
		...
		largeImageText: track.music?.album ?? "Unknown Album",
